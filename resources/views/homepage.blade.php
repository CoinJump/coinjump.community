...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    ...
    <link rel="stylesheet" href="/css/coinjump.css">
          ...
          <ul>
              ...
              <li style="margin-bottom: 6px">
                  <a href="{{ $pricejump->getPermalink() }}">
                      {{ $pricejump->coin->name }}: from {{ $pricejump->getPriceFromReadable() }} to {{ $pricejump->getPriceToReadable() }}
                  </a>

                  ({{ $pricejump->getPercentage() }}% {{ $pricejump->getPriceDirection() }} ) {{ $pricejump->created_at->diffForHumans() }}
              </li>
